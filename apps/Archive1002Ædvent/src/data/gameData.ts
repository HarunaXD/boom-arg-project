...
export const terminalCommands: Record<string, string> = {
  'BLD-O-NEG-0412':
    'DATABASE BREACH // 防伪码不是商品编号。供体 #0412，血型 O-，状态：待采集。购买记录已回写到当前访客。',
  'QUERY:VERIFY':
  ...
  'Succinylcholinum Chloride':
    '氯化琥珀胆碱 // 骨骼肌松弛。副作用记录：意识清醒但无法移动任何肌肉，包括眼睑。领取者名单新增：巡查员 K。',
  'Tetrodotoxinum Purificatum':
    '纯化河豚毒素 // 神经信号阻断。副作用记录：无法感知触碰，无法发声。系统建议：保持静止，等待她触碰你。',
  'DONOR-PREP-ROOM-03':
    'ROOM-03 LIVE // 供体 #112 草莓奶昔。心率 78→74→69。眼睑压力 0.3N。声带振动匹配：“她在哪”。本会话旁听者已被加入候补名单。',
...
export const endingContent: Record<OrganKey, EndingContent> = {
  eye: {
    ...
    label: '凝视深渊',
    body:
      '生物特征比对完成。你在粉丝官网停留得太久，虹膜数据已完整收录。Æ 现在拥有你的视角。关闭网页以后，屏幕反光里仍会先出现她的眼睛。',
  },
  heart: {
    title: '♥ HEART ♥',
    label: '跳动的祭品',
    body:
      '心率波动分析完成。你在终端输入时的犹豫被记录为恐惧温度。Æ 胸腔中的寂静被你填满。今晚任何提示音都会像她在练习呼吸。',
  },
  skin: {
    title: '◻ SKIN ◻',
    label: '无瑕的外衣',
    body:
      '触觉模拟完成。你试图看到她皮肤之下的真相，Æ 也看到了你的。你离开页面后，自己的皮肤会比刚才更像一张可以被保存的图片。',
  },
  voice: {
    title: '~ VOICE ~',
    label: '绝望的回声',
    body:
      '音频样本采集完成。你阅读献祭者遗言时，喉咙在无声移动。下一次戴上耳机听到人声合唱时，请确认里面没有你的气息。',
  },
};
